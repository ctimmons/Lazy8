...
{
  public static AssertionContext<T> Name<T>(this T source, String name) => (new AssertionContext<T>(name, source));
  ...
  public static AssertionContext<String> NotNullEmptyOrOnlyWhitespace(this String source) => (new AssertionContext<String>(source)).NotNullEmptyOrOnlyWhitespace();

  public static AssertionContext<String> NotNullEmptyOrOnlyWhitespace(this AssertionContext<String> source) => source.NotNull().NotEmpty().NotOnlyWhitespace();
