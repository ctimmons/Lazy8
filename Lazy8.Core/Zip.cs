...
/* Code for ZipExtensions is from StackOverflow answer https://stackoverflow.com/a/64582157/116198
   ...
   Modifications: 
     ...
     - Changed the type names to use framework types from System
...
{
  public static String CompressToBase64(this String uncompressedData) => Convert.ToBase64String(Encoding.UTF8.GetBytes(uncompressedData).Compress());

  public static String DecompressFromBase64(this String compressedData) => Encoding.UTF8.GetString(Convert.FromBase64String(compressedData).Decompress());
