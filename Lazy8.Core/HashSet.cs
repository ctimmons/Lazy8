...
public class GuardedHashSet<T> : HashSet<T>
{
  ...
  public GuardedHashSet(IEnumerable<T> collection, IEqualityComparer<T> comparer, Predicate<T> predicate) : base(collection, comparer) =>
    this._predicate = predicate;

  public GuardedHashSet(Int32 capacity, Predicate<T> predicate) : base(capacity) => this._predicate = predicate;

  public GuardedHashSet(Int32 capacity, IEqualityComparer<T> comparer, Predicate<T> predicate) : base(capacity, comparer) =>
    this._predicate = predicate;
